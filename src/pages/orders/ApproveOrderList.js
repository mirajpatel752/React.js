...
const ApproveOrdersList = ({ tabRender, setResetModuleData, resetModuleData, activeTabId, tabId, fullScreenTitleShow,
    tabShow, itemOption, setSelectedItem, selectedItem, rowSelection, setRowSelection, dataList = [], setDataList, isUpdateOrder }) => {
