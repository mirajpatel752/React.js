...
import { TabContent, TabPane, Nav, NavItem, NavLink, Button, Card, CardTitle, Input } from 'reactstrap'
import { useHistory } from 'react-router'
import AllMasterChannelItemList from './masterMappedItemList'
...
const MasterMappedItems = () => {
    ...
    const toggle = tab => {
        if (activeTabId !== tab) {
            setActiveTabId(tab)
            history.push(CommonRouter.master_mapped_items, { tab })
        }
    }
...
export default MasterMappedItems
