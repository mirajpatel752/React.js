...
const VerticalLayout = props => {
  ...
  const isHidden = useSelector(state => state.layout.menuHidden)
  ...
  return (
    <div
      className={classnames(
        ...
        } ${footerClasses[footerType] || 'footer-static'} ${history.location.pathname.includes('/company') ? 'munim-company-listing-page' : ''}`,
        {
          // Modern Menu
    ...
    >
      ...
      >
        ...
        <div className='navbar-container d-flex content gap-1'>
          {navbar ? (
            navbar
          ) : (
            <NavbarComponent
