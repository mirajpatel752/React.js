...
const VerticalNavMenuGroup = ({
  ...
  // const indicator_data = useSelector((state) => state.commonReducer.indicator_data)
  ...
  return (
    ...
    >
      <Link className='d-flex align-items-center' to='/' onClick={e => onCollapseClick(e, item)}>
        {item.icon}
        <span className='menu-title text-truncate lh-sm munim-menu-fnt'>{t(item.title)}</span>
